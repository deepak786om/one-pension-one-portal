...
export const MODULES = {
  ...
  service_verification: { label: "Service Validation", icon: "fileCheck", desc: "Validate Service Book and qualifying service." },
  ...
  case_workbench: { label: "Pension Cases", icon: "briefcase", desc: "Process retiring employees end-to-end: validate, forms, compute, forward to PAO." },
